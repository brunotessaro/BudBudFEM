subroutine Calc_Pressure_Octa8(Pressure,TFUNC,N,Time)
...
do iel = 1, nume ! loop nos elementos
     ...
     ! do i =1, 3  ! loop pontos gauss
            ...
            dNdx(1) = (y14*z15-z14*y15)*(-1+s+t-s*t)+(y15*z12-y12*z15)*(-1+r+t-t*r)+(y12*z14-y14*z12)*(-1+s+r-r*s)     !
            dNdy(1) = (x15*z14-x14*z15)*(-1+s+t-s*t)+(x12*z15-z12*x15)*(-1+r+t-t*r)+(-x12*z14+z12*x14)*(-1+s+r-r*s)    !
            dNdz(1) = (-x15*y14+x14*y15)*(-1+s+t-s*t)+(-x12*y15+y12*x15)*(-1+r+t-t*r)+(x12*y14-y12*x14)*(-1+s+r-r*s)  !
                                                                                                                     !
            dNdx(2) = (y14*z15-z14*y15)*(1-s-t+s*t)+(y15*z12-y12*z15)*(-r+t*r)+(y12*z14-y14*z12)*(-r+r*s)              !
            dNdy(2) = (x15*z14-x14*z15)*(1-s-t+s*t)+(x12*z15-z12*x15)*(-r+t*r)+(-x12*z14+z12*x14)*(-r+r*s)             !    Primeiras derivadas da funcao de forma
            dNdz(2) = (-x15*y14+x14*y15)*(1-s-t+s*t)+(-x12*y15+y12*x15)*(-r+t*r)+(x12*y14-y12*x14)*(-r+r*s)           !         avaliadas nos pontos de Gauss
                                                                                                                     !
            dNdx(3) = (y14*z15-z14*y15)*(s-s*t)+(y15*z12-y12*z15)*(r-t*r)-(y12*z14-y14*z12)*r*s                        !
            dNdy(3) = (x15*z14-x14*z15)*(s-s*t)+(x12*z15-z12*x15)*(r-t*r)-(-x12*z14+z12*x14)*r*s                       !
            dNdz(3) = (-x15*y14+x14*y15)*(s-s*t)+(-x12*y15+y12*x15)*(r-t*r)-(x12*y14-y12*x14)*r*s                     !
                                                                                                                     !
            dNdx(4) = (y14*z15-z14*y15)*(-s+s*t)+(y15*z12-y12*z15)*(1-r-t+t*r)+(y12*z14-y14*z12)*(-s+r*s)              !
            dNdy(4) = (x15*z14-x14*z15)*(-s+s*t)+(x12*z15-z12*x15)*(1-r-t+t*r)+(-x12*z14+z12*x14)*(-s+r*s)             !
            dNdz(4) = (-x15*y14+x14*y15)*(-s+s*t)+(-x12*y15+y12*x15)*(1-r-t+t*r)+(x12*y14-y12*x14)*(-s+r*s)           !
                                                                                                                     !
            dNdx(5) = (y14*z15-z14*y15)*(-t+s*t)+(y15*z12-y12*z15)*(-t+t*r)+(y12*z14-y14*z12)*(1-s-r+r*s)              !
            dNdy(5) = (x15*z14-x14*z15)*(-t+s*t)+(x12*z15-z12*x15)*(-t+t*r)+(-x12*z14+z12*x14)*(1-s-r+r*s)             !    Primeiras derivadas da funcao de forma
            dNdz(5) = (-x15*y14+x14*y15)*(-t+s*t)+(-x12*y15+y12*x15)*(-t+t*r)+(x12*y14-y12*x14)*(1-s-r+r*s)           !         avaliadas nos pontos de Gauss
                                                                                                                     !
            dNdx(6) = (y14*z15-z14*y15)*(t-s*t)-(y15*z12-y12*z15)*t*r+(y12*z14-y14*z12)*(r-r*s)                        !
            dNdy(6) = (x15*z14-x14*z15)*(t-s*t)-(x12*z15-z12*x15)*t*r+(-x12*z14+z12*x14)*(r-r*s)                       !
            dNdz(6) = (-x15*y14+x14*y15)*(t-s*t)-(-x12*y15+y12*x15)*t*r+(x12*y14-y12*x14)*(r-r*s)                     !
                                                                                                                     !
            dNdx(7) = (y14*z15-z14*y15)*s*t+(y15*z12-y12*z15)*t*r+(y12*z14-y14*z12)*r*s                                !
            dNdy(7) = (x15*z14-x14*z15)*s*t+(x12*z15-z12*x15)*t*r+(-x12*z14+z12*x14)*r*s                               !
            dNdz(7) = (-x15*y14+x14*y15)*s*t+(-x12*y15+y12*x15)*t*r+(x12*y14-y12*x14)*r*s                             !
                                                                                                                     !
            dNdx(8) = -(y14*z15-z14*y15)*s*t+(y15*z12-y12*z15)*(t-t*r)+(y12*z14-y14*z12)*(s-r*s)                       !
            dNdy(8) = -(x15*z14-x14*z15)*s*t+(x12*z15-z12*x15)*(t-t*r)+(-x12*z14+z12*x14)*(s-r*s)                      !    Primeiras derivadas da funcao de forma
            dNdz(8) = -(-x15*y14+x14*y15)*s*t+(-x12*y15+y12*x15)*(t-t*r)+(x12*y14-y12*x14)*(s-r*s)                    !          avaliadas nos pontos de Gauss
                                                                                                                     !
