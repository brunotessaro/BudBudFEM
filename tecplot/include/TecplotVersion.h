...
#define Tec360EditionName   "2015"     /* ""     for beta releases, or the year for production release */
#define Tec360ReleaseName   "Release 1" /* "Beta" for beta releases, or "Release #" for production releases*/
#define Tec360ReleaseAbbr   "R1" /* "Beta" for beta releases, or "R#" for production releases */
...
#define TecplotReleaseMonth        01   // Must include a leading zero for single-digit values (see request #29649)
