...
/**
 * SZLOD zone variable ID query service interface registered with Tecplot. The query service is
...
public:
     ...
     *     Resulting SZLOD cell centered variable data query service responsible for loading the
     ...
     * @param nodalVarQuery
     *     Resulting SZLOD nodal variable data query service responsible for loading the requested
     ...
     *     Resulting SZLOD query service responsible for performing various queries for the zone's
