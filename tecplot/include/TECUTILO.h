 ...
 */
LINKTOADDON TP_ARRAY_GIVES void* STDCALL TecUtilArrayAlloc(HgIndex_t   size,
 ...
 *
 * <FortranSyntax>
 *    REAL*8 FUNCTION TecUtilProbeFieldIsVarValid(VarNum)
 *    INTEGER*4 VarNum
 * </FortranSyntax>
 *
 * <PythonSyntax>
 ...
 *
 */
LINKTOADDON Boolean_t STDCALL TecUtilProbeFieldIsVarValid(EntIndex_t VarNum);
 ...
 * @since 14.3.0.0
 */
LINKTOADDON void STDCALL TecAppGetBaseDataLoadOptions(LgIndex_t* readDataOption, Boolean_t* resetStyle);
